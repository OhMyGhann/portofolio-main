        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
               I am a web developer with a passion for creating engaging user experiences. Proficient in HTML, CSS, and JavaScript, 
               I have a strong foundation in development skills. My specialization lies in using Laravel, React.js, and Vue.js 
               to build interactive web and mobile applications. With a focus on writing clean, maintainable code, 
               I strive to deliver seamless functionality. I am thrilled about the opportunity to join a dynamic team and contribute to building innovative products.
            </p>
